...
##Fixes made here
flags.DEFINE_string("out_dir", "data/narrativeqa", "Out dir [data/narrativeqa]")
flags.DEFINE_string("save_dir", "data/narrativeqa", "Out dir [data/narrativeqa]")
flags.DEFINE_string("log_dir", "data/narrativeqa", "Out dir [data/narrativeqa]")
flags.DEFINE_string("answer_dir", "data/narrativeqa", "Out dir [data/narrativeqa]")
flags.DEFINE_string("eval_dir", "data/narrativeqa", "Out dir [data/narrativeqa]")
flags.DEFINE_integer("max_num_sents", 10, "word count th [100]")
flags.DEFINE_integer("max_sent_size", 10, "word count th [100]")
flags.DEFINE_integer("max_ques_size", 10, "word count th [100]")
flags.DEFINE_integer("max_word_size", 10, "word count th [100]")
flags.DEFINE_integer("max_para_size", 10, "word count th [100]")
flags.DEFINE_integer("char_vocab_size", 10, "word count th [100]")
flags.DEFINE_integer("word_emb_size", 10, "word count th [100]")
flags.DEFINE_integer("word_vocab_size", 10, "word count th [100]")
flags.DEFINE_integer("vw_wo_entity_size", 10, "word count th [100]")
flags.DEFINE_integer("len_new_emb_mat", 10, "word count th [100]")
flags.DEFINE_integer("emb_mat", 10, "word count th [100]")
flags.DEFINE_integer("onehot_encoded", 10, "word count th [100]")
flags.DEFINE_boolean("pointer_network", False, "load saved data? [True]")
...
flags.DEFINE_integer("val_num_batches", 3, "validation num batches [100]")
...
flags.DEFINE_integer("sent_size_th", 900, "sent size th [64]")
flags.DEFINE_integer("num_sents_th", 2, "num sents th [8]")
flags.DEFINE_integer("ques_size_th", 20, "ques size th [32]")
flags.DEFINE_integer("word_size_th", 34, "word size th [16]")
flags.DEFINE_integer("para_size_th", 1500, "para size th [256]")
