...
class Model(object):
    ...
    def _build_loss(self):
        ...
        print ("LOSSES",tf.get_collection('losses_task2', scope=self.scope))
        ...
        tf.summary.scalar(self.loss_task1.op.name, self.loss_task1)
        tf.add_to_collection('ema/scalar', self.loss_task1)
    ...
    def _build_ema(self):
        ...
        with tf.control_dependencies([ema_op]):
            self.loss_task1 = tf.identity(self.loss_task1)
    ...
    def get_feed_dict(self, batch, is_train, supervised=True):
        ...
        if supervised:
            ...
            for i, spani in enumerate(batch.data['spans']):
                ...
                y[i, j_start, k_start] = True
                j_end, k_end = spani[1]
                y2[i, j_end, k_end] = True
