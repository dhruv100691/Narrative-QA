...
from basic.evaluator_nqa import ForwardEvaluator, MultiGPUF1Evaluator,BleuEvaluator,BleuEvaluatorSpan
...
def _train(config):
    ...
    #BLEU evaluator
    evaluator = BleuEvaluatorSpan(config, model, tensor_dict = model.tensor_dict if config.vis else None)
